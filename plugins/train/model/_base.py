...
class ModelBase():
    ...
    def store_input_shapes(self, model):
        ...
        if keras.backend.backend() == "plaidml.keras.backend": # PlaidML doesn't support tensor.get_shape()
    ...
    def compile_predictors(self):
        ...
        # PlaidML has a bug regarding the clipnorm parameter ( https://github.com/plaidml/plaidml/issues/228 ).
